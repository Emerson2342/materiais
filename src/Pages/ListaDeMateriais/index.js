...
const ListaDeMateriaisHtml = ({ listaDeMateriais, clienteMateriais }) => {
  //valor da data atual
...
<body>
  ...
  <div class="header">
      ...
      <div class="empregador">
          ...
          <p>Mais de 25 anos de experiência</p>
 ...
 <div>
              <p style="text-align: left;">Nome: ${
                clienteMateriais.cliente
              }</br>
               Telefone: ${clienteMateriais.telefone}</br>
               Endereço:${clienteMateriais.endereco}</p>
              </div>
  <table>
      <thead>
          <tr class="cabecalho">
...
export default function ListaDeMateriais() {
  ...
  const gerarPDF = async () => {
    try {
      const htmlString = ListaDeMateriaisHtml({
        listaDeMateriais,
        clienteMateriais,
      });
